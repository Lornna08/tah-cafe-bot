...
export const REVERSE_MARTINGALE = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [localize('Exploring the Reverse Martingale strategy in TAH Cafe')],
        expanded: true,
    ...
    {
        type: 'text',
        content: [localize('These are the trade parameters used in TAH Cafe with Reverse Martingale strategy.')],
    },
    {
        type: 'text',
        content: [
    ...
    },
    {
        ...
        content: [
            ...
            localize(
                '3. If the first trade is a successful trade, TAH Cafe will automatically double your stake for the next trade to 2 USD. TAH Cafe will continue to double the stake after every successful trade.'
            ),
            localize(
